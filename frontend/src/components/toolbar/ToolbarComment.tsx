  ...
  return (
    ...
    >
      ...
      <Tooltip content="Squiggly Underline">
        <Button variant={getToolVariant('squiggly')} size="icon" onClick={() => handleToolClick('squiggly' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
          <Activity className="w-4 h-4" />
        </Button>
      </Tooltip>

      <Tooltip content="Freehand / Ink">
        <Button variant={getToolVariant('ink')} size="icon" onClick={() => handleToolClick('ink' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
      ...
      <Tooltip content="Callout">
        <Button variant={getToolVariant('callout')} size="icon" onClick={() => handleToolClick('callout' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
          <SquareSquare className="w-4 h-4" />
        </Button>
      </Tooltip>

      <Tooltip content="Rectangle Shape">
        <Button variant={getToolVariant('shape-rect')} size="icon" onClick={() => handleToolClick('shape-rect' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
          <Square className="w-4 h-4" />
        </Button>
      </Tooltip>

      <Tooltip content="Polygon Shape">
        <Button variant={getToolVariant('shape-polygon')} size="icon" onClick={() => handleToolClick('shape-polygon' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
          <Hexagon className="w-4 h-4" />
        </Button>
      </Tooltip>

      <Tooltip content="Cloud Shape">
        <Button variant={getToolVariant('shape-cloud')} size="icon" onClick={() => handleToolClick('shape-cloud' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
          <Cloud className="w-4 h-4" />
        </Button>
      </Tooltip>

      <Tooltip content="Redaction">
        <Button variant={getToolVariant('redaction')} size="icon" onClick={() => handleToolClick('redaction' as unknown as Exclude<import("../../core/editor/types").ActiveTool, "select" | "hand">)}>
